...
mod tests {
    ...
    fn remove_element() {
        ...
        assert_eq!(0, Solution::remove_element(&mut v1, 0));

        let mut v1 = vec![3, 2, 2, 3];
        assert_eq!(2, Solution::remove_element(&mut v1, 3));

        let mut v1 = vec![0, 1, 2, 2, 3, 0, 4, 2];
        assert_eq!(5, Solution::remove_element(&mut v1, 2));

        let mut v1 = vec![1];
        assert_eq!(0, Solution::remove_element(&mut v1, 1));

        let mut v1 = vec![3, 3];
        assert_eq!(0, Solution::remove_element(&mut v1, 3));
    }
}
